...
public class scan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getPath();
        MusicAdapter musicAdapter=new MusicAdapter(scan.this,R.layout.music_item,musicList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    textView.setText("歌曲名："+music.getName()+"\n歌曲时长："+music.getDuration());
                }catch(Exception e){
                    e.printStackTrace();
                }
            }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                values.clear();
                Toast.makeText(scan.this,"添加成功！",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void getPath(){//扫描sd卡.mps储存到musicList
